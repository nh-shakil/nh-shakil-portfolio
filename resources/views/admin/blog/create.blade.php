...
@section('content')
    <div class="flex items-center justify-between">
        <div>
            <div class="text-sm text-white/60">Create blog post</div>
            <div class="mt-1 text-xs text-white/50">Write content and publish when ready.</div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.blog-posts.store') }}" enctype="multipart/form-data" class="mt-6">
        @csrf
