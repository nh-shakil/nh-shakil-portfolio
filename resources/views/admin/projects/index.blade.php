...
@section('content')
    <div class="flex items-center justify-between">
        <div class="text-sm text-white/60">Projects</div>
        <a
            ...
            <tbody class="divide-y divide-white/10">
                @forelse ($projects as $p)
                    <tr class="hover:bg-white/5">
                        ...
                        <td class="px-4 py-3 text-white/70">{{ $p->is_featured ? 'Yes' : 'No' }}</td>
                        <td class="px-4 py-3 text-white/70">{{ $p->images_count }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-10 text-center text-white/60">
