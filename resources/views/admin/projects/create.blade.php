...
@section('content')
    <div class="flex items-center justify-between">
        <div>
            <div class="text-sm text-white/60">Create project</div>
            <div class="mt-1 text-xs text-white/50">Add title, details, tech stack, and images.</div>
        </div>
    ...
    <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data" class="mt-6">
        @csrf
